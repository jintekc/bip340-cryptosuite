...
import { Btc1KeyManagerError, KeyPair, PrivateKey, PublicKey } from '../src/index.js';
...
describe('Multikey', () => {
  ...
  const publicKeyBytes = publicKey.compressed;
   ...
   * All parameters
   */
  describe('with all parameters: { id, controller, keyPair, publicKey }', () => {
    const multikey = new Multikey({ id, controller, keyPair, publicKey });
